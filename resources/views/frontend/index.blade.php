...
@section('content')
    ...
    <section class="current-items mb-4">
        <div class="container">
                            ...
                            @foreach ($selectedSpecifications as $specification)
                                @if ($specification->yacht_id == $recent_yacht->id)
                                    <div class="container d-flex justify-content-between px-5">
                                        <div class="my-2">{{ $specification->specification->specification_name }}:</div>
    ...
    <section class="current-items">
        <div class="container">
            <h3 class="items-title mb-3 text-center">Önerilen Tekneler</h3>
            <h6 class="items-subtitle text-center mb-3">Önerilen tekneler aşağıda listelenmiştir.</h6>
        </div>
        <div class="container d-flex gap-4 flex-wrap">
